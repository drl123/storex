defmodule Storex.SalesTest do
  ...
  describe "carts" do
    ...
    test "list_line_items/1 lists the line_items that belong to a cart" do
      book1 = book_fixture()
      book2 = book_fixture()
    ...
    test "line_items_quantity_count/1 returns the total quanity of items" do
      book1 = book_fixture()
      book2 = book_fixture()
  ...
  describe "orders" do
    ...
    test "process_order/3 creates and order" do
      user = user_fixture()
      cart = cart_fixture()
      book = book_fixture()
